  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "bg-gradient-primary text-primary-foreground hover:scale-105 shadow-medium hover:shadow-strong transition-spring font-semibold",
        earth: "bg-gradient-earth text-primary-foreground hover:bg-earth-dark shadow-soft hover:shadow-medium transition-smooth",
        nature: "bg-nature text-primary-foreground hover:bg-nature/90 shadow-soft hover:shadow-medium",
      },
      size: {
